...
import { getUserProfile, updateProfile, updatePassword, logout } from '../services/authService';
import './Profile.css';
        ...
        {activeTab === 'watchlist' && (
          <div className="watchlist-container">
            ...
            {user?.watchlist?.length > 0 ? (
              ...
              <p className="empty-message">You haven't added any movies to your watchlist yet.</p>
            )}
          </div>
        )}
      </div>
